...
$(function() {
    ...
    var abc = CKEDITOR.replace( 'editor-full', {
        height: '130px',
        // extraPlugins: 'forms'
    });

    CKEDITOR.instances['editor-full'].on('change', function(e) {

        var lnght = (abc.getData().length)-7;
        console.info(lnght);
        if (lnght > 10) {
            CKEDITOR.instances['editor-full'].setDate(abc.getData());
            // alert('stop');
        }
